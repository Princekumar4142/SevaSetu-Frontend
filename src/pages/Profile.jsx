...
export default function Profile() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-outline-variant/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm max-w-2xl mx-auto my-6 sm:my-8 space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={handleBack}
            className="w-9 h-9 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 active:bg-slate-300 flex items-center justify-center text-slate-800 dark:text-slate-100 transition-colors shrink-0"
            aria-label="Back"
          >
            <span className="material-symbols-outlined text-[20px]">arrow_back</span>
          </button>
          <div>
            <h1 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">Your Account Profile</h1>
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800 mt-2">
            {!confirmLogout ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-red-200 dark:border-red-900/60 bg-red-50 dark:bg-red-950/30 text-red-600 dark:text-red-400 text-xs font-bold hover:bg-red-100 dark:hover:bg-red-900/40 active:scale-[0.98] transition-all cursor-pointer"
              >
                <span className="material-symbols-outlined text-[18px]">logout</span>
                Log Out
              </button>
            ) : (
              <div className="rounded-2xl border border-red-200 dark:border-red-900/60 bg-red-50 dark:bg-red-950/30 p-4 space-y-3">
                <p className="text-xs font-bold text-red-800 dark:text-red-300 text-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-2 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 text-xs font-bold hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors cursor-pointer"
                  >
                    Cancel
                  </button>
                </div>
...
function Row({ label, value }) {
  return (
    <div className="flex justify-between py-3">
      ...
      <dd className="text-xs font-bold text-slate-800 dark:text-slate-200 capitalize">{value}</dd>
    </div>
  );
}
