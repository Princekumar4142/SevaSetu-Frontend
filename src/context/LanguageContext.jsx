...
export const TRANSLATIONS = {
  ...
  // ── Theme / Appearance ───────────────────────────────────────────────────
  theme_label: {
    hi: "थीम", en: "Theme", bn: "থিম", mr: "थीम",
    ta: "தீம்", te: "థీమ్", gu: "થીમ", kn: "ಥೀಮ್",
  },
  theme_light: {
    hi: "लाइट (हल्का)", en: "Light", bn: "লাইট", mr: "लाईट",
    ta: "ஒளி", te: "లైట్", gu: "લાઈટ", kn: "ಲೈಟ್",
  },
  theme_dark: {
    hi: "डार्क (गहरा)", en: "Dark", bn: "ডার্ক", mr: "डार्क",
    ta: "இருள்", te: "డార్క్", gu: "ડાર્ક", kn: "ಡಾರ್ಕ್",
  },
  theme_system: {
    hi: "सिस्टम (ऑटो)", en: "System", bn: "সিস্টেম", mr: "सिस्टम",
    ta: "கணினி", te: "సిస్టమ్", gu: "સિસ્ટમ", kn: "ಸಿಸ್ಟಮ್",
  },
  theme_appearance: {
    hi: "दिखावट और थीम", en: "Appearance & Theme", bn: "চেহারা ও থিম", mr: "दिसणे आणि थीम",
    ta: "தோற்றம் மற்றும் தீம்", te: "రూపురేఖలు & థీమ్", gu: "દેખાવ અને થીમ", kn: "ಗೋಚರತೆ ಮತ್ತು ಥೀಮ್",
  },
  theme_system_desc: {
    hi: "आपके डिवाइस की सेटिंग के अनुसार", en: "Follows your device settings", bn: "ডিভাইস সেটিংস অনুসরণ করে", mr: "डिव्हाइस सेटिंग्जप्रमाणे",
    ta: "சாதன அமைப்புகளைப் பின்தொடர்கிறது", te: "మీ పరికర సెట్టింగులను అనుసరిస్తుంది", gu: "ડિવાઇસ સેટિંગ્સ મુજબ", kn: "ಸಾಧನ ಸೆಟ್ಟಿಂಗ್‌ಗಳನ್ನು ಅನುಸರಿಸುತ್ತದೆ",
  },
  theme_light_desc: {
    hi: "साफ और चमकदार इंटरफ़ेस", en: "Clean and bright interface", bn: "পরিষ্কার ও উজ্জ্বল ইন্টারফেস", mr: "स्वच्छ आणि चमकदार इंटरफेस",
    ta: "சுத்தமான மற்றும் பிரகாசமான இடைமுகம்", te: "శుభ్రమైన మరియు ప్రకాశవంతమైన ఇంటర్‌ఫేస్", gu: "ચોખ્ખો અને તેજસ્વી ઇન્ટરફેસ", kn: "ಸ್ವಚ್ಛ ಮತ್ತು ಪ್ರಕಾಶಮಾನವಾದ ಇಂಟರ್ಫೇಸ್",
  },
  theme_dark_desc: {
    hi: "आँखों के लिए आरामदायक डार्क मोड", en: "Easy on the eyes in low light", bn: "চোখের পক্ষে আরামদায়ক ডার্ক মোড", mr: "डोळ्यांसाठी सुखद डार्क मोड",
    ta: "குறைந்த வெளிச்சத்தில் கண்களுக்கு இதமானது", te: "తక్కువ వెలుతురులో కళ్ళకు హాయిగా ఉంటుంది", gu: "ઓછા પ્રકાશમાં આંખો માટે આરામદાયક", kn: "ಕಡಿಮೆ ಬೆಳಕಿನಲ್ಲಿ ಕಣ್ಣುಗಳಿಗೆ ಆರಾಮದಾಯಕ",
  },

  // ── AI Voice Agent ───────────────────────────────────────────────────────
  ai_voice_booking_greeting: {
    en: "Namaste! I am SevaSetu AI Assistant. Say 'Book Electrician', 'Plumber needed', or tap any service below, and I'll book verified cooperative workers with fair wages for you!",
    hi: "नमस्ते! मैं SevaSetu AI Assistant हूँ। 'इलेक्ट्रीशियन बुक करो' या 'नल ठीक कराना है' बोलिए, या नीचे किसी सेवा पर टैप करें, मैं तुरंत उचित दरों पर सरकारी प्रमाणित कारीगर बुक कर दूँगा!",
    bn: "নমস্কার! আমি SevaSetu AI Assistant। বলুন 'ইলেকট্রিশিয়ান বুক করুন', 'প্লাম্বার লাগবে', অথবা নিচে যেকোনো সেবায় ট্যাপ করুন, আমি আপনার জন্য ন্যায্য মূল্যে বিশ্বস্ত কর্মী বুক করে দেব!",
    mr: "नमस्ते! मी SevaSetu AI Assistant आहे. 'इलेक्ट्रिशियन बुक करा', 'प्लंबर पाहिजे' असे बोला किंवा खालील सेवेवर टॅप करा, मी तुमच्यासाठी योग्य दरात प्रमाणित सहकारी कामगार बुक करेन!",
    ta: "வணக்கம்! நான் SevaSetu AI Assistant. 'எலக்ட்ரீஷியன் புக் பண்ணுங்க', 'பிளம்பர் வேணும்' என்று சொல்லுங்கள், அல்லது கீழே உள்ள சேவையை தட்டுங்கள், நான் உங்களுக்காக சரியான விலையில் திறமையான தொழிலாளர்களை பதிவு செய்வேன்!",
    te: "నమస్తే! నేను SevaSetu AI Assistant. 'ఎలక్ట్రీషియన్ బుక్ చేయండి', 'ప్లంబర్ కావాలి' అని చెప్పండి, లేదా క్రింది సేవను ఎంచుకోండి, నేను మీ కోసం తక్కువ ధరలో ధృవీకరించబడిన కార్మికులను బుక్ చేస్తాను!",
    gu: "નમસ્તે! હું SevaSetu AI Assistant છું. 'ઇલેક્ટ્રિશિયન બુક કરો', 'પ્લમ્બર જોઈએ છે' બોલો, અથવા નીચેની સેવા પસંદ કરો, હું તમારા માટે વ્યાજબી દરે પ્રમાણિત કારીગરો બુક કરી આપીશ!",
    kn: "ನಮಸ್ಕಾರ! ನಾನು SevaSetu AI Assistant. 'ಎಲೆಕ್ಟ್ರಿಷಿಯನ್ ಬುಕ್ ಮಾಡಿ', 'ಪ್ಲಂಬರ್ ಬೇಕು' ಎಂದು ಹೇಳಿ, ಅಥವಾ ಕೆಳಗಿನ ಸೇವೆಯನ್ನು ಆರಿಸಿ, ನಾನು ನಿಮಗಾಗಿ ನ್ಯಾಯಯುತ ದರದಲ್ಲಿ ಪರಿಶೀಲಿಸಿದ ಕಾರ್ಮಿಕರನ್ನು ಬುಕ್ ಮಾಡುತ್ತೇನೆ!",
  },
  ai_greeting: {
